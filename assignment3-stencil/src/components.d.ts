...
declare global {
  ...
  interface HTMLMyDescriptionElement
    extends Components.MyDescription,
      HTMLStencilElement {}
  ...
  interface HTMLMySalebannerElement
    extends Components.MySalebanner,
      HTMLStencilElement {}
  var HTMLMySalebannerElement: {
    prototype: HTMLMySalebannerElement;
    new (): HTMLMySalebannerElement;
  };
  interface HTMLProductVariationElement
    extends Components.ProductVariation,
      HTMLStencilElement {}
  var HTMLProductVariationElement: {
    prototype: HTMLProductVariationElement;
    new (): HTMLProductVariationElement;
  };
  interface HTMLStartseiteNavigationElement
    extends Components.StartseiteNavigation,
      HTMLStencilElement {}
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      "my-description": LocalJSX.MyDescription &
        JSXBase.HTMLAttributes<HTMLMyDescriptionElement>;
      ...
      "my-salebanner": LocalJSX.MySalebanner &
        JSXBase.HTMLAttributes<HTMLMySalebannerElement>;
      "product-variation": LocalJSX.ProductVariation &
        JSXBase.HTMLAttributes<HTMLProductVariationElement>;
      "startseite-navigation": LocalJSX.StartseiteNavigation &
        JSXBase.HTMLAttributes<HTMLStartseiteNavigationElement>;
    }
  }
}
